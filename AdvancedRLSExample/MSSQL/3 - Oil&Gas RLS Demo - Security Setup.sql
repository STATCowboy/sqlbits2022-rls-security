...
DECLARE user_cursor CURSOR
   FOR
   SELECT userid from [sqlbits2022].dbo.[SEC_ORG_USER_BASE];
OPEN user_cursor;
...
BEGIN;
   ...
   EXECUTE ('create login [' + @username + '] WITH PASSWORD=N''oilgaspass123!'', DEFAULT_DATABASE=[sqlbits2022], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF;');
   FETCH NEXT FROM user_cursor INTO @username;
END;
